                        ...
                        <div class="col-lg-4 mt-n3 order-lg-2 order-1">
                            <div class="mt-n5">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mb-0 fs-4">{{ $profile_inf->bio }}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-none border">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        @endif
                                        @if(!empty($profile_inf->email))
                                        <!-- عرض عنصر li إذا كانت البيانات غير فارغة -->
                                        <li class="d-flex align-items-center gap-3 mb-4">
                                            <i class="fa fa-envelope text-dark fs-6"></i>
                                            <h6 class="fs-4 fw-semibold mb-0"><a href="/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="39414043535657584d515857795e54585055175a5654">{{ $profile_inf->email }}</a>
                                            </h6>
                                        </li>
                                        @endif
                                        @if(!empty($profile_inf->universe_name))
                                        <!-- عرض عنصر li إذا كانت البيانات غير فارغة -->
                                        <li class="d-flex align-items-center gap-3 mb-4">
                                            <i class="fa fa-graduation-cap text-dark fs-6"></i>
                                            <h6 class="fs-4 fw-semibold mb-0">{{ $profile_inf->universe_name }}</h6>
                                        </li>
                                        @endif
                                        @if(!empty($profile_inf->school_name))
                                        <!-- عرض عنصر li إذا كانت البيانات غير فارغة -->
                                        <li class="d-flex align-items-center gap-3 mb-4">
                                            <i class="fa fa-graduation-cap text-dark fs-6"></i>
                                            <h6 class="fs-4 fw-semibold mb-0">{{ $profile_inf->school_name }}</h6>
                                        </li>
                                        @endif
                                        @if(!empty($profile_inf->location))
                                        <!-- عرض عنصر li إذا كانت البيانات غير فارغة -->
                                        <li class="d-flex align-items-center gap-3 mb-4">
                                            <i class="fa fa-home text-dark fs-6"></i>
                                            <h6 class="fs-4 fw-semibold mb-0">{{ $profile_inf->location }}</h6>
                                        </li>
                                        @endif
                                        @if(!empty($profile_inf->date_of_birth))
                                        <!-- عرض عنصر li إذا كانت البيانات غير فارغة -->
                                        <li class="d-flex align-items-center gap-3 mb-4">
                                            <i class="fa fa-birthday-cake text-dark fs-6"></i>
                                            <h6 class="fs-4 fw-semibold mb-0">{{ $profile_inf->date_of_birth }}</h6>
                                        </li>
                                        @endif
                                        @if(!empty($profile_inf->gender))
                                        <!-- عرض عنصر li إذا كانت البيانات غير فارغة -->
                                        <li class="d-flex align-items-center gap-3 mb-4">
                                            <i class="fa fa-user text-dark fs-6"></i>
                                            <h6 class="fs-4 fw-semibold mb-0">{{ $profile_inf->gender }}</h6>
                                        </li>
                                        @endif
                                    </ul>
                                </div>
